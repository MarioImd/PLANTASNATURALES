...
export class Veterinaria {
  ...
  // Ejemplo: this.productService.getProductsByCategory('Veterinaria')
  // ============================================================================
  ...
  // Filtrar productos solo de la categoría "Veterinaria"
  products = computed(() =>
    this.allProducts().filter(product => product.category === 'Veterinaria')
  );
