...
export class Plantas {
  ...
  // Ejemplo: this.productService.getProductsByCategory('Plantas Naturales')
  // ============================================================================
  ...
  // Filtrar productos solo de la categoría "Plantas Naturales"
  products = computed(() =>
    this.allProducts().filter(product => product.category === 'Plantas Naturales')
  );
